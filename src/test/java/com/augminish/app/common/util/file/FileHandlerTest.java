...
public class FileHandlerTest {
    ...
    public static void initialize() {
        ...
        Assert.assertTrue("The delete method should clean the testing directory if it exists", 
                filehandler.delete("./.ignore/data/www.augminishtest.com/testing_file.html"));
    }
